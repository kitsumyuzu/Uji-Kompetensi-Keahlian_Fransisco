                                ...
                                <div class="col-md-4">
                                    <div class="mb-4">
                                        <div class="justify-content-center align-items-center d-flex">
                                            <img src="<?php echo base_url('assets/src/stored_profile/'.($data_user['_profile'] ? $data_user['_profile'] : 'default-profile.png')) ?>" id="profile_preview" alt="profile" style="width: 70px; height: 70px; border-radius: 100%; object-fit: cover;">
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                          ...
                                          <div class="row">
                                              <div class="form-group col-md-6 grid-margin">
                                                  ...
                                                  <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" maxlength="255" value="<?php echo $data_user['nama_lengkap'] ?>">
                                              </div>
                                              <div class="form-group col-md-6 grid-margin">
